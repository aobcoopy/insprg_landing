...
$(function(){
	...
	$("#tb_data").DataTable({
		"processing": true,
		"serverSide": true,
		"ajax": "apps/group/db/data_blog.php",
		"aoColumns": [
			{ "bSortable": false},
		...
		"createdRow": function ( row, data, index ) {
			...
			s = '';
			s += fn.engine.datatable.button('btn-primary','fa-pencil','fn.group.change('+data[0]+')');
			/*s += ' ';
...
//			$('td', row).eq(7).html(a);
	...
	fn.engine.datatable.add_selectable('tb_data','chk_group');
